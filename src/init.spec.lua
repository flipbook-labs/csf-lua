...
local index.jsModule = require(script["index.js"]);
local toId = index.jsModule.toId;
local storyNameFromExport = index.jsModule.storyNameFromExport;
local isExportStory = index.jsModule.isExportStory;
describe("toId", function()
local testCases: Array<Array<string
| string
| nil>> = {
...
{"non-latin", "\u{41A}\u{43D}\u{43E}\u{43F}\u{43A}\u{438}", "\u{43D}\u{43E}\u{440}\u{43C}\u{430}\u{43B}\u{44C}\u{43D}\u{44B}\u{439}", "\u{43A}\u{43D}\u{43E}\u{43F}\u{43A}\u{438}--\u{43D}\u{43E}\u{440}\u{43C}\u{430}\u{43B}\u{44C}\u{43D}\u{44B}\u{439}"},
{"korean", "kind", "\u{BC14}\u{BCF4} (babo)", "kind--\u{BC14}\u{BCF4}-babo"},
{"all punctuation", "kind", "unicorns,\u{2019}\u{2013}\u{2014}\u{2015}\u{2032}\u{BF}`\"<>()!.!!!{}[]%^&$*#&", "kind--unicorns"}}
;
...
local testCases = {name = "Name", someName = "Some Name", someNAME = "Some NAME", some_custom_NAME = "Some Custom NAME", someName1234 = "Some Name 1234", someName1_2_3_4 = "Some Name 1 2 3 4"};
...
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /a/ ]]})).toBeTruthy();
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /.*/ ]]})).toBeTruthy();
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /b/ ]]})).toBeFalsy();
expect(isExportStory("a", {excludeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /a/ ]]})).toBeFalsy();
expect(isExportStory("a", {excludeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /.*/ ]]})).toBeFalsy();
expect(isExportStory("a", {excludeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /b/ ]]})).toBeTruthy();
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /a/ ]], excludeStories = {"a"}})).toBeFalsy();
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /.*/ ]], excludeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /.*/ ]]})).toBeFalsy();
expect(isExportStory("a", {includeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /a/ ]], excludeStories = error("not implemented") --[[ ROBLOX TODO: Unhandled node for type: RegExpLiteral ]] --[[ /b/ ]]})).toBeTruthy();
end);
end);
