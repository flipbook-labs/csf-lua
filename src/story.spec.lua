...
local Renderer = story.jsModule.Renderer;
local Args = story.jsModule.Args;
local ArgsFromMeta = story.jsModule.ArgsFromMeta;
local ArgsStoryFn = story.jsModule.ArgsStoryFn;
local ComponentAnnotations = story.jsModule.ComponentAnnotations;
local DecoratorFunction = story.jsModule.DecoratorFunction;
local LoaderFunction = story.jsModule.LoaderFunction;
local ProjectAnnotations = story.jsModule.ProjectAnnotations;
local StoryAnnotationsOrFn = story.jsModule.StoryAnnotationsOrFn;
local StrictArgs = story.jsModule.StrictArgs; -- NOTE Example of internal type definition for @storybook/<X> (where X is a renderer)
type XRenderer = Renderer & { component: (args:typeof((({} :: any) :: any --[[ ROBLOX TODO: Unhandled node for type: TSThisType ]] --[[ this ]]).T)) -> string,
storyResult: string,
...
local meta = {component = Button, args = {disabled = false}, render = renderer, decorators = {decorator1, decorator2, decorator3, decorator4}, loaders = {loader, loader2}};
